      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-5 text-gray-600 text-base sm:text-lg leading-7 sm:leading-8">
            Visit our office or contact us for professional land
            surveying services in S. Kota and nearby areas.
          </p>
        ...
        <div className="mt-12 rounded-3xl overflow-hidden shadow-2xl">
          ...
          <iframe
            ...
            src="https://www.google.com/maps?q=Srungavarapukota,Andhra%20Pradesh&output=embed"
